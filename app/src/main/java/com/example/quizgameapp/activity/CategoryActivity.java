package com.example.quizgameapp.activity;
...
import com.example.quizgameapp.databinding.ActivityCategoryBinding;
import com.example.quizgameapp.fragments.LoginDialogfragment;
import com.example.quizgameapp.interfaces.InternetRefreshCallback;
import com.example.quizgameapp.interfaces.OnLoginCallbackListener;
import com.example.quizgameapp.model.Category_Pojo;
import com.example.quizgameapp.quiz_adapters.Category_Adapter;
import com.example.quizgameapp.quiz_preferences.SharedPreferences;
import com.example.quizgameapp.retrofit_libs.APIClient;
import com.example.quizgameapp.retrofit_libs.APIInterface;
import com.example.quizgameapp.utils.AppLog;
import com.example.quizgameapp.utils.CommonUtils;
...
public class CategoryActivity extends com.example.quizgameapp.activity.ParentActicity implements InternetRefreshCallback {
                    ...
                    public boolean onNavigationItemSelected(MenuItem menuItem) {
                        ...
                        switch (menuItem.getItemId()) {
                            ...
                            case R.id.nav_favourite:
                                CategoryActivity.super.sendIntent(com.example.quizgameapp.activity.FavouriteActivity.class, null);
                                break;
                            ...
                            case R.id.nav_profile:
                                ...
                                break;
                            case R.id.nav_faq:
                                CategoryActivity.super.sendIntent(com.example.quizgameapp.activity.FaqActivity.class, null);
                                break;
                            case R.id.nav_terms:
                                CategoryActivity.super.sendIntent(com.example.quizgameapp.activity.TermsActivity.class, null);
                                break;
                            case R.id.nav_setting:
                                CategoryActivity.super.sendIntent(com.example.quizgameapp.activity.SettingActivity.class, null);
                                break;
    ...
    private void goToProfile() {
        if (CommonUtils.getInstance().isUserLoggedIn(mContext))
            CategoryActivity.super.sendIntent(com.example.quizgameapp.activity.ProfileActivity.class, null);
        else {
    ...
    private void goToLeaderBoard() {
        if (CommonUtils.getInstance().isUserLoggedIn(mContext))
            CategoryActivity.super.sendIntent(com.example.quizgameapp.activity.LeaderBoardActivity.class, null);
        else {
            LoginDialogfragment newFragment = LoginDialogfragment.getInstance(true, mContext, mActivity, new OnLoginCallbackListener() {
                @Override
                public void OnCancel() {
    ...
    private void init_Header() {
        ...
        mBinding.searchToolbar.search_icon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CategoryActivity.super.sendIntent(com.example.quizgameapp.activity.Search_Activity.class, bundle);
            }
        });
