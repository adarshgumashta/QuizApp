...
import com.example.quizgameapp.databinding.ActivityQuizBinding;
...
import com.example.quizgameapp.model.QuizList_Pojo;
import com.example.quizgameapp.model.User;
import com.example.quizgameapp.quiz_adapters.QuizList_Adapter;
...
import com.example.quizgameapp.utils.RecyclerItemClickListener;
...
public class FavouriteActivity extends com.example.quizgameapp.activity.ParentActicity implements InternetRefreshCallback {
        ...
        mBinding.rvQuizes.addOnItemTouchListener(
                new RecyclerItemClickListener(mContext, new RecyclerItemClickListener.OnItemClickListener() {
                    @Override public void onItemClick(View view, int position) {
                        ...
                        mActivity.startActivity(new Intent(mActivity, com.example.quizgameapp.activity.StartQuizActivity.class).putExtra("bundle",bundle));
